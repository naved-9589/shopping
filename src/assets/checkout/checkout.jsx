                ...
                <div class="grid min-h-screen grid-cols-10">
                    <div class="col-span-full py-6 px-4 sm:py-12 lg:col-span-6 lg:py-24">
                        <div class="mx-auto w-full max-w-lg">
                            <h1 class="relative text-2xl font-medium text-gray-700 sm:text-3xl">Secure Checkout<span class="mt-2 block h-1 w-10 bg-red-400 sm:w-20"></span></h1>
                            ...
                            <button type="submit" class="mt-8 inline-flex w-full items-center justify-center rounded bg-red-400 py-2.5 px-4 text-base font-semibold tracking-wide text-white text-opacity-80 outline-none ring-offset-2 transition hover:text-opacity-100 focus:ring-2 focus:ring-teal-500 sm:text-lg">Place Order</button>
                        </div>
                    </div>
                    <div class="relative col-span-full flex flex-col py-6 pl-8 pr-4 sm:py-12 lg:col-span-4 lg:py-24">
                        ...
                        <div>
                            ...
                            <div class="absolute inset-0 h-full w-full bg-gradient-to-t from-red-600 to-red-400 opacity-95"></div>
                        </div>
                        <div class="relative">
                            <ul class="space-y-5">
